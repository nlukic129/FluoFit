-- 0039 — expose order id + subscription id in the member detail so the support console can act on
-- a specific order (refund) and subscription. Same as 0023 with ids added to the orders array.
