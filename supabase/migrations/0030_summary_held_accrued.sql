-- 0030 — Summary "Held commissions" should mean commissions genuinely HELD (in the 30-day
-- hold / review window) = state 'accrued' only. Payable (ready to pay) is the separate
-- "Pending payout" KPI. Keeps the two admin actions distinct: review vs pay.
