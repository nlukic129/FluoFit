...
2. **Spend-funded** — FluoFit absorbs a **bounded** COGS (premium flavors, upgraded Box). Safe because XP is floored by Boxes purchased: a high Level can only be reached by a Member who has already spent enough to cover the Perk out of their own margin.
